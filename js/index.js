...
const miscKeywordsHeader = document.getElementById('miscellaneous-keywords-header');
...
const miscKeywordsTipBtn = document.getElementById('miscellaneous-keywords-tip-button');
miscKeywordsTipBtn.addEventListener('click', () => (showDialog(getLocalizedText('miscellaneous-keywords-tip-button'))));
const miscKeywordsInput = document.getElementById('miscellaneous-keywords-input');
const miscKeywordsItemsDiv = document.getElementById('miscellaneous-keywords-container');
const resumeMiscKeywordsDiv = document.getElementById('miscellaneous-keywords-resume-container');
const miscKeywordsItemsBtn = document.getElementById('add-miscellaneous-keywords-button');
const miscKeywordsAreaMsgSpan = document.getElementById('miscellaneous-keywords-message-span');
